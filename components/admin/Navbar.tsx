...
function Navbar() {
  return (
    <div className="flex  justify-end items-center border-b-[1px] mt-[2%] pb-[2%]">
      <Link href={"/admin/messege"} className="ml-6">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <img
        ...
        alt=""
      />
      <div className="ml-[5.4%] flex flex-col items-center mt-[1%]">
        <p className="text-[#064247] font-iranSansLight  text-[16px]">
          علی مکارمی
        </p>
        <p className="text-[#288E87] font-iranSansMedium text-[12px]">پزشک</p>
      </div>
    </div>
  );
}
