  ...
  const layoutData = [
        ...
        >
          <path
            className={`group-hover:stroke-white ${
              pathName?.includes("/admin/myPatient") ? "stroke-white" : stroke
            }`}
    ...
    },
    {
      icon: (
        ...
        >
          <path
            className={`group-hover:stroke-white ${
              pathName?.includes("/admin/reservation") ? "stroke-white" : stroke
            }`}
    ...
    },
    {
      icon: (
        ...
        >
          <path
            className={`group-hover:stroke-white ${
              pathName === "/admin/clerk" ? "stroke-white" : stroke
            }`}
    ...
    },
    {
      ...
      subMenuItems: [
        ...
        { title: "بلاگ و مقالات", path: "/admin/changeInfo/addarticle" },
        { title: "نظرات", path: "/admin/changeInfo/opinion" },
        { title: "آدرس و تلفن", path: "/admin/changeInfo/Map" },
      ],
    },
    {
      icon: (
              ...
              {item.subMenu ? (
                <>
                  <div
                    ...
                    className={`flex h-[57px] items-center rounded-lg font-iranSansLight cursor-pointer   hover:bg-[#288E87] hover:text-white hover:rounded-lg
                     `}
                  >
