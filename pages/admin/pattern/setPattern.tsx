    ...
    <Layout>
      ...
      <div className="flex justify-between mt-[10%]">
        <div className="flex flex-col">
          ...
          <button className="text-white bg-[#064247] text-[12px] w-[40px] h-[30px] rounded-md mt-[5%]">تایید</button>
        </div>
        <div className="ml-[8%] flex flex-col">
          <h1 className="mb-[15%] text-[#064247] text-[14px]">این زمان‌بندی برای چه روزهایی از ماه آینده می‌باشند؟</h1>
          {/* <DatePicker /> */}
          <Calendar
            value={selectedDay}
          ...
          />
          <p className="text-[14px] text-[#064247] font-iranSansBold mt-[10%]">هزینه ویزیت</p>
          <input
            type="text"
            placeholder="300,000 تومان"
            className=" rounded-md border-[1px] border-gray-300 w-[386px] h-[63px] placeholder:text-[#757575] placeholder:text-[12px] placeholder:pr-[8px] my-[2%]"
          />
          <p className="text-[#CBCBCB] text-[12px] ">لطفا هزینه هر ویزیت را به تومان وارد کنید.</p>
          <div className="flex justify-between mt-[10%]">
          <button className=" text-white bg-[#064247] text-[12px] rounded-3xl w-[111px] h-[36px]">برنامه اول</button>
          <button className=" text-white bg-[#064247] text-[12px] rounded-3xl w-[111px] h-[36px]">برنامه دوم</button>
          <button className=" text-white bg-[#064247] text-[12px] rounded-3xl w-[111px] h-[36px]">برنامه سوم</button>
          </div>
        </div>
      </div>
      <button className="w-[246px] h-[48px] text-white bg-[#288E87] rounded-md mx-auto mt-[10%]">جدول زمان‌بندی را بساز</button>
