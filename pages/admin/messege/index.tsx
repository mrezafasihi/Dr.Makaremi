  ...
  const member = [
    {
      ...
      tik: (
        ...
        >
          <path
            d="M0 5.10113L3.92004 7.98645L10.2146 1.04892L8.96988 0L3.69358 5.81528L1.0017 3.83382L0 5.10113ZM16 1.04892L14.7553 0L9.4914 5.80173L8.86905 5.32191L7.83594 6.5669L9.69306 8L16 1.04892Z"
            fill="#83DCD6"
          />
        </svg>
      ),
                ...
                <Link href={`/admin/messege/${item.id}`}>
                  <div className="max-w-[875px] h-[90px] border-gray-200 border-[1px]  mt-[10px] flex justify-between rounded-md">
                    <div className="flex flexcol mt-[2%] mr-[2%] w-[35%]">
                      ...
                      <div className="mr-[5%]">
                        <p className="text-[#0D0630] text-[18px]">
                          {item.name}
                        </p>
                    ...
                    <div className="mt-[3%] ml-[3%]">
                      <p className="w-[28px] h-[20px] text-[12px]">
                        {item.clock}
                      </p>
                    </div>
                  </div>
